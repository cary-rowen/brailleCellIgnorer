...
addon_info = AddonInfo(
	...
	addon_name="brailleCellIgnorer",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Braille Cell Ignorer"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""An NVDA add-on that allows you to ignore damaged or malfunctioning braille display cells."""),
	# version
	addon_version="0.1.0",
	...
	addon_url="https://github.com/cary-rowen/brailleCellIgnorer",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/cary-rowen/brailleCellIgnorer",
...
pythonSources: list[str] = ["addon/globalPlugins/brailleCellIgnorer/*.py"]
